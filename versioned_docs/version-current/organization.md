...
1. **Course Content:** All scripts and assignments are managed in GitHub repositories
2. **Student Work:** Fork the main repository and work in feature branches
3. **Submission:** Create Pull Requests for assignment submissions
4. **Review Process:** Peer and instructor reviews before merging
