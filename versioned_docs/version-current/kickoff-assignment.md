...
1. Go to the course repository: `https://github.com/[instructor]/visdat-course`
...
git remote add upstream git@github.com:[instructor]/visdat-course.git
